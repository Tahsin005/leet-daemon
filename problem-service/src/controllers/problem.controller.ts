...
export const ProblemController = {
    ...
    async getProblemById(req: Request<{ id: string }>, res: Response): Promise<void> {
    ...
    async updateProblem(req: Request<{ id: string }>, res: Response): Promise<void> {
    ...
    async deleteProblem(req: Request<{ id: string }>, res: Response): Promise<void> {
